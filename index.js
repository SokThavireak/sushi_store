...
app.post('/api/cart', checkAuthenticated, cartController.addToCart); 
...
// Orders (UPDATED: All point to checkoutController now)
app.get('/admin/orders', checkAuthenticated, checkRole(['manager', 'admin', 'store_manager', 'staff', 'cashier']), checkoutController.getOrders); 
...
app.post('/admin/orders/handle-request/:id', checkAuthenticated, checkRole(['admin', 'manager', 'store_manager']), checkoutController.handleOrderRequest);

// Order Editing (UPDATED: 'updateAdminOrder' -> 'updateOrderDetails')
app.post('/admin/orders/update/:id', checkAuthenticated, checkRole(['manager', 'admin', 'store_manager', 'staff', 'cashier']), checkoutController.updateOrderDetails);
app.get('/admin/orders/edit/:id', checkAuthenticated, checkRole(['manager', 'admin', 'store_manager', 'staff', 'cashier']), checkoutController.getEditOrder);
app.get('/admin/orders/delete/:id', checkAuthenticated, checkRole(['manager', 'admin', 'store_manager', 'staff', 'cashier']), checkoutController.deleteOrder);
app.get('/admin/orders/items/delete/:itemId', checkAuthenticated, checkRole(['manager', 'admin', 'store_manager', 'staff', 'cashier']), checkoutController.deleteOrderItem);
app.post('/admin/orders/items/update/:itemId', checkAuthenticated, checkRole(['manager', 'admin', 'store_manager', 'staff', 'cashier']), checkoutController.updateOrderItem);
...
app.get('/admin/stock', checkAuthenticated, checkRole(['manager', 'admin', 'store_manager']), stockOrderController.getStockOrders); 
...
// Categories
app.get('/admin/category', checkAuthenticated, checkRole(['manager', 'admin']), categoryController.getCategories); 
